...
typedef enum __nfpack TouchGestureVelocity
{
    TouchGestureVelocity_Slow = 0,
    TouchGestureVelocity_Medium = 1,
    TouchGestureVelocity_Fast = 2,
} TouchGestureVelocity;
...
struct Library_nanoFramework_Graphics_nanoFramework_Presentation_UIElement
{
    ...
    static const int FIELD__TouchGesture = 5;
    static const int FIELD___parent = 6;
    static const int FIELD___logicalChildren = 7;
    static const int FIELD___flags = 8;
    static const int FIELD___visibility = 9;
    static const int FIELD___requestedSize = 10;
    static const int FIELD___anchorInfo = 11;
    static const int FIELD___marginLeft = 12;
    static const int FIELD___marginTop = 13;
    static const int FIELD___marginRight = 14;
    static const int FIELD___marginBottom = 15;
    static const int FIELD___horizontalAlignment = 16;
    static const int FIELD___verticalAlignment = 17;
    static const int FIELD___finalX = 18;
    static const int FIELD___finalY = 19;
    static const int FIELD___finalWidth = 20;
    static const int FIELD___finalHeight = 21;
    static const int FIELD___offsetX = 22;
    static const int FIELD___offsetY = 23;
    static const int FIELD___renderWidth = 24;
    static const int FIELD___renderHeight = 25;
    static const int FIELD___previousAvailableWidth = 26;
    static const int FIELD___previousAvailableHeight = 27;
    static const int FIELD___desiredWidth = 28;
    static const int FIELD___desiredHeight = 29;
    static const int FIELD___unclippedWidth = 30;
    static const int FIELD___unclippedHeight = 31;
    static const int FIELD___instanceEventHandlersStore = 32;
    static const int FIELD___isEnabledChanged = 33;
    static const int FIELD___isVisibleChanged = 34;
...
{
    static const int FIELD___borderBrush = 38;
    static const int FIELD___borderLeft = 39;
    static const int FIELD___borderTop = 40;
    static const int FIELD___borderRight = 41;
    static const int FIELD___borderBottom = 42;
...
{
    static const int FIELD___background = 35;
    static const int FIELD___foreground = 36;
...
struct Library_nanoFramework_Graphics_nanoFramework_Presentation_Controls_DockPanel
{
    ...
    static const int FIELD___lastChildFill = 35;
...
{
    static const int FIELD___bitmap = 35;
...
{
    static const int FIELD___isSelectable = 38;
    static const int FIELD___listBox = 39;
...
{
    static const int FIELD___scrollViewer = 38;
    static const int FIELD___panel = 39;
    static const int FIELD___selectedIndex = 40;
    static const int FIELD___selectionChanged = 41;
    static const int FIELD___items = 42;
...
{
    static const int FIELD___previousHorizontalOffset = 38;
    static const int FIELD___previousVerticalOffset = 39;
    static const int FIELD___horizontalOffset = 40;
    static const int FIELD___verticalOffset = 41;
    static const int FIELD___extentWidth = 42;
    static const int FIELD___extentHeight = 43;
    static const int FIELD___scrollableWidth = 44;
    static const int FIELD___scrollableHeight = 45;
    static const int FIELD___lineHeight = 46;
    static const int FIELD___lineWidth = 47;
    static const int FIELD___scrollingStyle = 48;
    static const int FIELD___scrollChanged = 49;
...
{
    static const int FIELD___orientation = 35;
...
{
    static const int FIELD___font = 35;
    static const int FIELD___foreColor = 36;
    static const int FIELD___text = 37;
    static const int FIELD___textWrap = 38;
    static const int FIELD___trimming = 39;
    static const int FIELD___alignment = 40;
...
{
    static const int FIELD__TextRuns = 35;
    static const int FIELD___lineCache = 36;
    static const int FIELD___alignment = 37;
    static const int FIELD___currentLine = 38;
    static const int FIELD___scrollingStyle = 39;
...
{
    static const int FIELD___itemWidth = 35;
    static const int FIELD___itemHeight = 36;
...
struct Library_nanoFramework_Graphics_nanoFramework_Presentation_FrameworkElement
{
    static const int FIELD__DataContext__BackingField = 35;
...
{
    static const int FIELD___direction = 37;
...
{
    static const int FIELD___pts = 37;
...
{
    static const int FIELD___fill = 35;
    static const int FIELD___stroke = 36;
...
struct Library_nanoFramework_Graphics_nanoFramework_Presentation_WindowManager
{
    ...
    static const int FIELD___postRenderHandler = 35;
...
struct Library_nanoFramework_Graphics_nanoFramework_UI_TouchCoordinate
{
    static const int FIELD__X = 1;
    static const int FIELD__Y = 2;
...
{
    static const int FIELD___sizeToContent = 38;
    static const int FIELD___windowManager = 39;
...
struct Library_nanoFramework_Graphics_nanoFramework_UI_DisplayControl
{
    ...
    static const int FIELD_STATIC__MaximumBufferSize__BackingField = 22;
...
struct Library_nanoFramework_Graphics_nanoFramework_UI_Input_TouchEvents
{
    ...
    static const int FIELD_STATIC__TouchGestureEvent = 34;
...
{
    static const int FIELD_STATIC___initialized = 35;
    static const int FIELD_STATIC___activeTouchPanel = 36;
...
{
    static const int FIELD__Gesture = 1;
    static const int FIELD__Velocity = 2;
...
struct Library_nanoFramework_Graphics_nanoFramework_UI_TouchScreen
{
    ...
    static const int FIELD__OnTouchGesture = 7;
